...
function getForecast() {
    ...
    // first card
    foreCastCard1.children("h5").text(weather.list[4].dt_txt[0]);
    ...
    //second card
    foreCastCard2.children("h5").text(weather.list[12].dt_txt[0]);
    ...
    //third card
    foreCastCard3.children("h5").text(weather.list[20].dt_txt[0]);
    ...
    //fourth card
    foreCastCard4.children("h5").text(weather.list[28].dt_txt[0]);
    ...
    //fifth card
    foreCastCard5.children("h5").text(weather.list[36].dt_txt[0]);
